...
export default function CardContract() {
  return (
    <Card sx={{ maxWidth: 345, margin: "20px" }}>
      ...
      <CardActions>
        <Button size="small" sx={{ color: "black", background: "#0077ff" }}>Click here to contact a Lawyer</Button>
        <Button size="small" sx={{ color: "black", background: "#0077ff" }}>Click here to see all contracts</Button>
      </CardActions>
    </Card>
  );
}